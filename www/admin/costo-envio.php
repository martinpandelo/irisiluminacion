                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <form action="costo-envio.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-2"></div>
                                            <div class="col-sm-10">
                                                <button type="submit" name="submit" value="agregar" class="btn btn-success btn-lg">ACTUALIZAR</button>
                                            </div>
                                        </div>

                                				<?php $costos=$ordenes->traer_costo_envio(); 
												while ($costo=$costos->fetch_assoc())
													{ ?>
														<div class="form-group">
															<label for="<?php echo $costo['id_costo'] ?>" class="col-sm-6 control-label"><?php echo $costo['zona'] ?></label>
															<div class="col-sm-6">
                                                            	<div class="input-group">
                                                                    <div class="input-group-addon">$</div>
                                                                    <input name="<?php echo $costo['id_costo'] ?>" type="text" value="<?php if(isset($_POST["{$costo['id_costo']}"])) echo $_POST["{$costo['id_costo']}"]; else echo $costo['precio']; ?>" class="form-control"/>
                                                                </div>
															</div>
														</div>						
