...
$id_noticia=filter_input(INPUT_GET, 'nt_id', FILTER_SANITIZE_SPECIAL_CHARS);
$accion=filter_input(INPUT_GET, 'accion', FILTER_SANITIZE_SPECIAL_CHARS);


if (!empty($_POST['submit'])) {
    $result=$Obj->editar_noticia($id_noticia);
}

if ($accion=='publicado') {
    $result=$Obj->status_noticia($id_noticia,$accion);
} else if($accion=='papelera') {
    $result=$Obj->status_noticia($id_noticia,$accion);
}

$contenido=$Obj->traer_noticia($id_noticia);
                                ...
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="titulo" value="<?php if(isset($_POST['titulo'])) echo $_POST['titulo']; else echo $contenido['nt_titulo']; ?>" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="texto" class="col-sm-2 control-label">Texto principal</label>
                                            <div class="col-sm-10">
                                                <textarea name="texto" required><?php if(isset($_POST['texto'])) echo $_POST['texto']; else echo $contenido['nt_texto'];?></textarea>
                                                <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control m-b-sm" name="estado">
                                                    ...
                                                    <option value="papelera" <?php if ($estado=='papelera') { echo 'selected'; }; ?>>En borrador</option>
                                                </select>
                                            </div>
                                        </div>
        ...
        $(document).ready(function(){
           ...
           $("#marca").change(function () {
                   $("#marca option:selected").each(function () {
                    id_partner = $(this).val();
                    categoria= <?php if(isset($_POST['categoria'])) echo $_POST['categoria']; else echo '0'; ?>;
                    $.post("include/combo-select-categoria.php", { id_partner: id_partner,categoria: categoria }, function(data){
                        $("#categoria").html(data);
                    });            
                });
           })
           $("#categoria").change(function () {
                   $("#categoria option:selected").each(function () {
                    ...
                    subcategoria= <?php if(isset($_POST['subcategoria'])) echo $_POST['subcategoria']; else echo '0'; ?>;
                    $.post("include/combo-select-subcategoria.php", { id_categoria: id_categoria,subcategoria: subcategoria }, function(data){
