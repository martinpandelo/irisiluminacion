        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Editar texto emails estado: <strong><?php echo $contenido['st_nombre']; ?></strong></h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li><a href="estados-orden.php">Estados de ordenes de compra</a></li>
                            <li class="active">Editar email estados</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="texto" required><?php if(isset($_POST['texto'])) echo $_POST['texto']; else echo $contenido['st_text_email'];?></textarea>
                                                <script>
