                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal" action="agregar-noticia.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="titulo" value="<?php if(isset($_POST['titulo'])) echo $_POST['titulo']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="texto" required><?php if(isset($_POST['texto'])) echo $_POST['texto']; ?></textarea>
                                                <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control m-b-sm" name="estado">
                                                    ...
                                                    <option value="papelera">En borrador</option>
                                                </select>
                                            </div>
                                        </div>
