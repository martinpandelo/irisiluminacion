        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Estados Ordenes</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Estados Ordenes</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
        ...
        <script type="text/javascript">
            $( document ).ready(function() {
                ...
                if (isset($result)) {
                    switch ($result) {
                        case 'agregado': 
                            echo 'toastr["success"]("Os dados foram carregados corretamente")';
                            break;
                        case 'eliminado':
                            echo 'toastr["success"]("Os dados foram excluídos corretamente")';
                            break;
                        case 'actualizado':
                            echo 'toastr["success"]("Os dados foram atualizados corretamente")';
                            break;
                        default:
