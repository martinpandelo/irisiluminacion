...
if (isset($_POST['submit']) && $_POST['submit']=='sincronizar') {
    $result=$Obj->sincronizarTodosProductos();
}
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Sincronizar productos</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">       
                                    ...
                                    <div class="alert alert-info" role="alert"> <strong>ATENCIÓN</strong> con el siguiente botón se sincronizaran todos los productos con Mercado Libre<br>
                                    Los cambios en los productos se verán reflejados pasados 30 minutos aproximadamente.</div>

                                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button type="submit" name="submit" value="sincronizar" class="btn btn-danger btn-lg">Sincronizar todos los productos</button>
                                            </div>
                                        </div>
                                    </form>
        ...
        <script type="text/javascript">
            $( document ).ready(function() {
                ...
                if (isset($result)) {
                    switch ($result) {
                        case true: 
                            echo 'toastr["success"]("La sincronización está en marcha. Verás reflejado los cambios pasados 30 minutos.")';
                            break;
                        default:
