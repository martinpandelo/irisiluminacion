                    ...
                    $.ajax({
                      ...
                      success: function(response)  
                      {
                        ...
                        for (var i = 0; i < response.length; i++) {
                             html_data += '<tr><td><img id="thumbnil" src="'+response[i].im_400x400+'" class="img-thumbnail" width="200"/></td>';
                             ...
                             html_data += '<td><a href="fotos-productos.php?id='+response[i].im_producto+'&action=delete&img='+response[i].im_400x400+'" data-confirm="Está seguro que desea eliminar?" class="btn btn-danger btn-lg"><i class="fa fa-trash"></i> Remover</a></td></tr>';
                         };
