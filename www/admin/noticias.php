...
switch ($action) {
  case 'delete' :
    $result = $Obj->borrar_noticia($id);
    break;
  case 'publicado' :
        $result=$Obj->status_noticia($id,$action);
        break;
  case 'papelera' :
        $result=$Obj->status_noticia($id,$action);
        break;
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                          <a href="agregar-noticia.php" class="btn btn-success btn-addon m-b-sm btn-rounded btn-lg"><i class="fa fa-plus"></i> Agregar cliente</a>
                          <a href="ordenar-noticias.php" class="btn btn-warning btn-addon m-b-sm btn-rounded btn-lg"><i class="fa fa-arrows-v"></i> Ordenar clientes</a>
