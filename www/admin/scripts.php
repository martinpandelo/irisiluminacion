...
<html>
    ...
    <body class="page-header-fixed small-sidebar">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group">
                                            <button type="submit" name="submit" value="agregar" class="btn btn-success btn-lg">GUARDAR</button>
                                        </div>

                                        <?php $script=$Obj->traerScripts();
                                            $scr=$script->fetch_assoc();
										?>
                                                 
                                        <div class="form-group">
                                            <h3>Script entre head</h3>
                                            <textarea id="scriptHead" name="scriptHead"><?php echo $scr['scr_head'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <h3>Script apertura body</h3>
                                            <textarea id="scriptBody" name="scriptBody"><?php echo $scr['scr_body'] ?></textarea>
                                        </div>
                                    </form>
        ...
        <script>
        var editor = CodeMirror.fromTextArea(document.getElementById("scriptHead"), {
            lineNumbers: true
        });
        var editor = CodeMirror.fromTextArea(document.getElementById("scriptBody"), {
            lineNumbers: true
        });
        </script>
