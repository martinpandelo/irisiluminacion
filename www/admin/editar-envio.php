                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Editar envios</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="provincia" name="provincia" required>
                                                    <?php 
                                                      if(isset($_POST['provincia'])) $provincia=$_POST['provincia']; else $provincia=$contenido['env_provincia'];
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nombre" value="<?php if(isset($_POST['nombre'])) echo $_POST['nombre']; else echo $contenido['env_nombre'];?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="descripcion" ><?php if(isset($_POST['descripcion'])) echo $_POST['descripcion']; else echo $contenido['env_descripcion']; ?></textarea>
                                                <script>
															CKEDITOR.replace( 'descripcion', {
																
																removePlugins: 'bidi,font,forms,flash,horizontalrule,iframe,justify,table,tabletools,smiley',
																removeButtons: 'Anchor,Image,Blockquote,Strike,Outdent,Indent,About',
																format_tags: 'p',
																/*
																 * Core styles.
																 */
                                        ...
                                        <div class="form-group">
                                            <label for="horas_entrega" class="col-sm-2 control-label">Tiempo de entrega</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="horas_entrega" value="<?php if(isset($_POST['horas_entrega'])) echo $_POST['horas_entrega']; else echo $contenido['env_horas_entrega'];?>">
                                            </div>
                                        </div>


                                        <div class="form-group">
                                            <label for="precio_normal" class="col-sm-2 control-label">Precio normal</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="precio_normal" step="0.01" value="<?php if(isset($_POST['precio_normal'])) echo $_POST['precio_normal']; else echo $contenido['price_normal'];?>" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="precio_especial" class="col-sm-2 control-label">Precio especial</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="precio_especial" step="0.01" value="<?php if(isset($_POST['precio_especial'])) echo $_POST['precio_especial']; else echo $contenido['price_especial'];?>" required>
                                            </div>
                                        </div>
