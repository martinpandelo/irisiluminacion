                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Agregar envío</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="horas_entrega" value="<?php if(isset($_POST['horas_entrega'])) echo $_POST['horas_entrega'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="precio_normal" step="0.01" value="<?php if(isset($_POST['precio_normal'])) echo $_POST['precio_normal']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="precio_especial" step="0.01" value="<?php if(isset($_POST['precio_especial'])) echo $_POST['precio_especial']; ?>" required>
                                            </div>
                                        </div>
