...
$contenido=$Obj->traer_noticia($id);
?>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Imagen para clientes</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Imagen para clientes</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                  <h2><strong><?php echo $contenido['nt_titulo'] ?></strong></h2>
                                  <hr>
                                  <?php $Obj->BotonesImgNot($id); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function getEmployee() {
                    $.ajax({
                      type: "GET",  
                      url: "include/generar_img_noticias.php?id="+<?php echo $id ?>,
                      dataType: "json",       
                      success: function(response)  
                      {
                        var html_data = '';
                        for (var i = 0; i < response.length; i++) {
                             html_data += '<tr><td><img id="thumbnil" src="../img/proyectos/'+response[i].im_nombre+'" class="img-thumbnail" width="200"/></td>';
                             ...
                             html_data += '<td><a href="upload_crop-not.php?nom_fot='+response[i].nombreFot+'" class="btn btn-success btn-lg"><i class="fa fa-edit"></i> Editar</a></td>';

                             html_data += '<td><a href="fotos-noticias.php?id='+response[i].im_producto+'&action=delete&img='+response[i].im_nombre+'" data-confirm="Está seguro que desea eliminar?" class="btn btn-danger btn-lg"><i class="fa fa-trash"></i> Eliminar</a></td></tr>';
                         };
                ...
                make_editable_col('#example tbody','a#im_orden','include/generar_img_noticias.php?action=edit','Orden');
