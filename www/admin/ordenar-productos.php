        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Ordenar todos los productos</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Ordenar todos los productos</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
          ...
          $(function() {
            $( "#sortable" ).sortable({
                update: function(event, ui) {
                        ...
                        $.ajax({
                            url: 'include/reordenar-productos.php',
                            data: {"data": orden},
                            type: 'post'
                        }).done(function(data) {
                    });
