...
if (isset($_POST['submit'])) {
	$result=$ordenes->editarDescuentoTransf();
} 

$contenido=$ordenes->traerDescuentoTransf();
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Descuento para Transferencias Bancarias</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Descuento para Transferencias Bancarias</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-xs-7">
                                                    <div class="form-group">
                                                        <label for="descuento" class="col-sm-4 control-label">% de descuento:</label>
                                                        <div class="col-sm-8">
                                                            <input name="descuento" type="text" value="<?php if(isset($_POST['descuento'])) echo $_POST['descuento']; else echo $contenido['porcentaje_descuento']; ?>" class="form-control"/>
                                                        </div>
                                                    </div>
                                </div>
                                </form>
