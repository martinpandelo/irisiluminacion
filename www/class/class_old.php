...
class mainClass {
    ...
    public function productosFeed2()

	{
        ...
        if ($query->rowCount()>0) {
            ...
            {   
                ...
                $queryImg = $this->conn->prepare("SELECT im_400x400, im_800x800, im_padding, IF(im_externa='si', -1, im_orden) AS orden FROM `tbl_img` WHERE im_producto=? ORDER BY orden ASC LIMIT 2");
